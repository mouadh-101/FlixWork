 ...
 */
class getTrainingCategoryRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\TrainingCategoryRepository' shared autowired service.
     *
     * @return \App\Repository\TrainingCategoryRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TrainingCategoryRepository.php';

        return $container->privates['App\\Repository\\TrainingCategoryRepository'] = new \App\Repository\TrainingCategoryRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
