...
(isset($context["post"]) || array_key_exists("post", $context) ? $context["post"] : (function () { throw new RuntimeError('Variable "post" does not exist.', 17, $this->source); })()), "etat", [], "any", false, false, false, 17) == "approved")) {
        ...
        echo "</p>
                    <a href=\"";
        // line 25
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("updatepost", ["id" => twig_get_attribute($this->env, $this->source, (isset($context["post"]) || array_key_exists("post", $context) ? $context["post"] : (function () { throw new RuntimeError('Variable "post" does not exist.', 25, $this->source); })()), "id", [], "any", false, false, false, 25)]), "html", null, true);
...
";
    ...
    {
        return array (  126 => 26,  122 => 25,  118 => 24,  114 => 22,  108 => 20,  102 => 18,  100 => 17,  95 => 16,  93 => 15,  88 => 14,  86 => 13,  82 => 12,  77 => 10,  68 => 3,  58 => 2,  35 => 1,);
    }
    ...
    <section class=\"section\">
            <div class=\"card\">
                <div class=\"card-body\">
                    ...
                    <a href=\"{{ path( 'updatepost' , {'id' : post.id})}}\" class=\"card-link\">Update postulation </a>
                    <a href=\"{{ path( 'deletepost' , {'id' : post.id})}}\" class=\"card-link\">Delete postulation</a>
                </div>
            </div>
    </section>
</main>
