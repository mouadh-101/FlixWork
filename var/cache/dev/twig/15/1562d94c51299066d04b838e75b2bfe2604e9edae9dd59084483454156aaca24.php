...
(isset($context["interview"]) || array_key_exists("interview", $context) ? $context["interview"] : (function () { throw new RuntimeError('Variable "interview" does not exist.', 21, $this->source); })()), "etat", [], "any", false, false, false, 21) == "approved")) {
        ...
        echo "</p>
                    ...
                    <p class=\"card-text\">";
        // line 30
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["interview"]) || array_key_exists("interview", $context) ? $context["interview"] : (function () { throw new RuntimeError('Variable "interview" does not exist.', 30, $this->source); })()), "getInterviewLink", [], "method", false, false, false, 30), "html", null, true);
        echo "</p>
                    <a href=\"";
        // line 31
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("updateinterview", ["id_i" => twig_get_attribute($this->env, $this->source, (isset($context["interview"]) || array_key_exists("interview", $context) ? $context["interview"] : (function () { throw new RuntimeError('Variable "interview" does not exist.', 31, $this->source); })()), "id", [], "any", false, false, false, 31), "id_u" => (isset($context["idUser"]) || array_key_exists("idUser", $context) ? $context["idUser"] : (function () { throw new RuntimeError('Variable "idUser" does not exist.', 31, $this->source); })())]), "html", null, true);
        echo "\" class=\"card-link\">Update Interview </a>
                    <a href=\"";
        // line 32
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("deleteinterview", ["id_i" => twig_get_attribute($this->env, $this->source, (isset($context["interview"]) || array_key_exists("interview", $context) ? $context["interview"] : (function () { throw new RuntimeError('Variable "interview" does not exist.', 32, $this->source); })()), "id", [], "any", false, false, false, 32), "id_u" => (isset($context["idUser"]) || array_key_exists("idUser", $context) ? $context["idUser"] : (function () { throw new RuntimeError('Variable "idUser" does not exist.', 32, $this->source); })())]), "html", null, true);
        echo "\" class=\"card-link\">Delete Interview</a>
                    <a href=\"";
        // line 33
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("list_interview", ["id" => (isset($context["idUser"]) || array_key_exists("idUser", $context) ? $context["idUser"] : (function () { throw new RuntimeError('Variable "idUser" does not exist.', 33, $this->source); })())]), "html", null, true);
...
";
    ...
    {
        return array (  142 => 33,  138 => 32,  134 => 31,  130 => 30,  125 => 28,  121 => 26,  115 => 24,  109 => 22,  107 => 21,  102 => 20,  100 => 19,  95 => 18,  93 => 17,  89 => 16,  84 => 14,  79 => 12,  68 => 3,  58 => 2,  35 => 1,);
    }
    ...
    <section class=\"section\">
            <div class=\"card\">
                <div class=\"card-body\">
                    ...
                    <h6 class=\"card-subtitle mb-2 text-muted\">Link :</h6>
                    <p class=\"card-text\">{{ interview.getInterviewLink()}}</p>
...
", "interview/detailinterview.html.twig", "C:\\Users\\mouad\\Documents\\GitHub\\FlixWork\\templates\\interview\\detailinterview.html.twig");
    }
}
