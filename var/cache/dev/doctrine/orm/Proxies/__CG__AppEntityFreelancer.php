...
class Freelancer extends \App\Entity\Freelancer implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Freelancer' . "\0" . 'cv', '' . "\0" . 'App\\Entity\\Freelancer' . "\0" . 'portfolio_link', '' . "\0" . 'App\\Entity\\Freelancer' . "\0" . 'bio', '' . "\0" . 'App\\Entity\\Freelancer' . "\0" . 'evaluation'];
        }
