 ...
 */
class JobsCategory extends \App\Entity\JobsCategory implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\JobsCategory' . "\0" . 'id', '' . "\0" . 'App\\Entity\\JobsCategory' . "\0" . 'category_name'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (JobsCategory $proxy) {
