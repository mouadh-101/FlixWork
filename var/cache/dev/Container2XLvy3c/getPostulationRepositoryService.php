 ...
 */
class getPostulationRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PostulationRepository' shared autowired service.
     *
     * @return \App\Repository\PostulationRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PostulationRepository.php';

        return $container->privates['App\\Repository\\PostulationRepository'] = new \App\Repository\PostulationRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
