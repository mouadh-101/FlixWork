 ...
 */
class getJobsCategoryRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\JobsCategoryRepository' shared autowired service.
     *
     * @return \App\Repository\JobsCategoryRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'JobsCategoryRepository.php';

        return $container->privates['App\\Repository\\JobsCategoryRepository'] = new \App\Repository\JobsCategoryRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
